...
Этот режим подходит, если у вас нет сервера. GitHub будет запускать бота каждый день в 07:00 по Новосибирску, бот отправит отчет и завершит работу.
...
Дальше GitHub будет запускать workflow каждый день в 00:00 UTC, что соответствует 07:00 в Новосибирске.
